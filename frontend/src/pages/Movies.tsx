...
function Movies() {
  ...
  const displayMovies = movieData?.getMovies && movieData.getMovies.movies.map((movie?: Movie) => <MovieCard children={movie?.title} picture={movie?.posterurl || ""} storyline="" id={movie?.id || ""} />);
